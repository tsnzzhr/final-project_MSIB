...
<div class="container">
    ...
    <div class="row mb-2">
        <div class="col-3 p-3 text-center">
            ...
            <a href="/final_project/views/patient/form_konsul_1.php" class="btn dash p-3 mt-4">Pasien Obesitas & Diet Sehat</a>
        </div>
        <div class="col-3 p-3 text-center">
            <img src="/final_project/assets/img/pregnancy.png" width="120" height="120">
            <a href="/final_project/views/" class="btn dash p-3 mt-4">Pasien Ibu Hamil & Menyusui</a>
        </div>

        <div class="col-3 p-3 text-center">
            <img src="/final_project/assets/img/cookie.png" width="120" height="120">
            <a href="/final_project/views/" class="btn dash p-3 mt-4">Pasien Gizi Umum</a>
        </div>
